  ...
  for(
    ...
    */
    ...
    /*
      ...
      SẢN XUẤT THỰC TẾ kể từ đầu ca — dùng chung
      advanceProductionTime() với exitTime, để né breaks
      một cách CỘNG DỒN (không chỉ kiểm tra xe có rơi
      đúng vào giữa 1 break hay không như cách cũ, vì
      cách cũ không tính đúng ảnh hưởng của các break
      TRƯỚC ĐÓ dồn lên toàn bộ các xe phía sau).
    */
