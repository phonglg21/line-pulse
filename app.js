...
function syncEntryLog(
  ...
  for(
    ...
    */
    ...
    /*
      Xe thứ N trong ngày = cộng dồn ĐÚNG N×takt giây
      SẢN XUẤT THỰC TẾ kể từ đầu ca, dùng ĐÚNG takt
      của NGÀY ĐÓ (UPH có thể khác nhau giữa các ngày,
      suy ngược từ Planned Qty / Working Hours) — dùng
      chung advanceProductionTime() để né breaks một
      cách CỘNG DỒN (không chỉ kiểm tra xe có rơi đúng
      vào giữa 1 break hay không như cách cũ, vì cách cũ
      không tính đúng ảnh hưởng của các break TRƯỚC ĐÓ
      dồn lên toàn bộ các xe phía sau).
    */
