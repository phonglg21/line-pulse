    ...
    .on(
      ...
      payload => {
        ...
        try{
          ...
          /*
            REAL TIME: đồng hồ PHẢI luôn lấy theo
            giờ thiết bị hiện tại, không lấy simTime
            từ bản ghi Supabase (bản ghi này luôn là
            snapshot cũ vài giây so với hiện tại, kể cả
            khi chính client này tự echo lại state của
            mình). Nếu không loại trừ, mỗi lần nhận
            broadcast đồng hồ sẽ bị kéo lùi lại vài giây
            rồi lại tự nhảy tiến ngay khung hình sau
            => cảm giác "nhảy phút linh tinh".
          */
